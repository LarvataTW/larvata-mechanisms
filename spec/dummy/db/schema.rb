...
ActiveRecord::Schema.define(version: 2021_04_15_073358) do
  ...
  create_table "funcs", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.string "desc"
    t.string "ancestry"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["ancestry"], name: "index_funcs_on_ancestry"
    t.index ["name"], name: "index_funcs_on_name"
  end

  create_table "permissions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.bigint "role_id"
    t.bigint "func_id"
    t.index ["func_id"], name: "index_permissions_on_func_id"
  ...
  add_foreign_key "permissions", "funcs"
