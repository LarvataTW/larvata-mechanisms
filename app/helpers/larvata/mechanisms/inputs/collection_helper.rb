module Larvata::Mechanisms::Inputs::CollectionHelper
  ...
  def select_tag(form:, label:, field_name:, collection: [], value_method: :first, text_method: :last, input_class_name: '', value: '', disabled: false, multiple: false, allow_clear: true)
